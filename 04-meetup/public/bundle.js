...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 21, 4, 421);
    			attr_dev(header, "class", "svelte-869a0d");
    			add_location(header, file, 20, 0, 408);
    		},
    ...
    /* src/UI/Button.svelte generated by Svelte v3.29.0 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 87, 4, 1654);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 85, 4, 1618);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-zlikzn");
    			add_location(h1, file$2, 69, 8, 1128);
    			attr_dev(h2, "class", "svelte-zlikzn");
    			add_location(h2, file$2, 70, 8, 1153);
    			attr_dev(p0, "class", "svelte-zlikzn");
    			add_location(p0, file$2, 71, 8, 1181);
    			attr_dev(header, "class", "svelte-zlikzn");
    			add_location(header, file$2, 68, 4, 1111);
    			if (img.src !== (img_src_value = /*imageUrl*/ ctx[2])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", /*title*/ ctx[0]);
    			attr_dev(img, "class", "svelte-zlikzn");
    			add_location(img, file$2, 73, 23, 1235);
    			attr_dev(div0, "class", "image svelte-zlikzn");
    			add_location(div0, file$2, 73, 4, 1216);
    			attr_dev(p1, "class", "svelte-zlikzn");
    			add_location(p1, file$2, 75, 8, 1314);
    			attr_dev(div1, "class", "content svelte-zlikzn");
    			add_location(div1, file$2, 74, 4, 1284);
    			attr_dev(footer, "class", "svelte-zlikzn");
    			add_location(footer, file$2, 77, 4, 1350);
    			attr_dev(article, "class", "svelte-zlikzn");
    			add_location(article, file$2, 67, 0, 1097);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (21:4) {#each meetups as meetup (meetup.id)}
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(21:4) {#each meetups as meetup (meetup.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-qd6ng9");
    			add_location(section, file$3, 19, 0, 358);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$4, 45, 11, 913);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$4, 44, 8, 860);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$4, 42, 4, 783);
    			attr_dev(div, "class", "form-control svelte-19icdtr");
    			add_location(div, file$4, 41, 0, 752);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	function addMeetup() {
    		...
    		$$invalidate(6, meetups = [newMeeetup, ...meetups]);
    	}
